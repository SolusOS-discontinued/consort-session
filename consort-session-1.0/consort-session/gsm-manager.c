...
#define GSM_MANAGER_DBUS_PATH "/org/consort/SessionManager"
#define GSM_MANAGER_DBUS_NAME "org.consort.SessionManager"
...
#define GSM_MANAGER_SCHEMA        "org.consort.SessionManager"
            ...
            GsmManager *manager)
{
        ...
        if (manager->priv->phase < GSM_MANAGER_PHASE_APPLICATION) {
                 ...
                 * so consort-session assumes process exit means "ok
...
/*
  dbus-send --session --type=method_call --print-reply
      --dest=org.consort.SessionManager
      /org/consort/SessionManager
